...
# --- Allocation Slider ---
st.sidebar.write("Monthly Loan Payment ($)")
...
with col1:
    ...
    if number_value != st.session_state.loan_payment_slider:
        st.session_state.loan_payment_slider = number_value
        st.rerun()
...
with col2:
    ...
    if slider_value != st.session_state.loan_payment_slider:
        st.session_state.loan_payment_slider = slider_value
        st.rerun()

loan_payment_amount = st.session_state.loan_payment_slider
